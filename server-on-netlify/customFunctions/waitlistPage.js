const waitlistPage = (referralUrl, fbUrl, twitterUrl, emailUrl, linkedInUrl, textMessageUrl, numberOfReferrals, positionInLine, totalInLine) => {
    ...
    return `
        ...
        <link href="https://res.cloudinary.com/ayli-inc/raw/upload/v1583388717/Supply%20Side/Website%20Files/CSS/project-kickdown.webflow.css" rel="stylesheet" type="text/css">
